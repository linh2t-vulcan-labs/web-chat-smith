...
export const ExpressSubscriptionActionButton: React.FC<
  ...
  return (
    <div
      className={cn(
        ...
        "p-v1-4 z-10 md:mx-0 md:p-0",
        "dark:bg-surface-general-shade-overlay md:backdrop-blur-0 backdrop-blur-[10px] md:bg-transparent",
    ...
    >
      ...
      <Button
        type="button"
        className="mb-small-0 rounded-rounded text-bodyM-medium dark:text-text-general-primary md:rounded-pill-soft md:text-bodyM-highlight order-2 h-[36px] font-medium text-white md:order-1 md:h-[56px] md:font-semibold"
        onClick={() => onContinue?.()}
      >
        {submitBtnText}
        <SVGIcon
