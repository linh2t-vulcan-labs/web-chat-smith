...
const DEFAULT_SEEN_MODELS: TSelectionListProps["seenModels"] = [];
...
const SelectionList = forwardRef<HTMLDivElement, TSelectionListProps>(
  (
    ...
    // oxlint-disable-next-line react/react-compiler -- ref .current values are read during render to feed the scrollspy hook's positional tracking; intentional pattern for this hook's API
