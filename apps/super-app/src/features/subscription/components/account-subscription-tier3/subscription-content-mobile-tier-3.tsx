...
const SubscriptionContentMobileTier3: React.FC<
...
> = ({
  ...
  return (
    <>
      <div className="gap-large-4 px-medium-2 flex h-[calc(100%-96px)] flex-col overflow-y-auto">
        {/* Subscription list */}
        <div
        ...
        >
          <div className="gap-large-4 pb-large-4 flex flex-col">
            <div className="gap-large-4 flex flex-col">
              <div className="text-app-Title1">
                {dsT.rich("getPro", {
                ...
                {SUBSCRIPTION_PRO_FEATURES.map((benefit, idx) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      <div className="text-footnoteM-highlight text-text-general-secondary">
                        {dsT(benefit.feature)}
                      </div>
                    </div>
                  </div>
...
export default SubscriptionContentMobileTier3;
