...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 bg-v1-surface-overlay-emphasis-blocking fixed inset-0 isolate z-50 backdrop-blur-none duration-100",
        className
      )}
      {...props}
    />
