...
// oxlint-disable-next-line eslint/no-empty-function -- intentional no-op default for context's setShowValues until a real Provider supplies one
const noop = () => {};
...
export const EnvironmentVariables = ({
  ...
  const contextValue = { setShowValues, showValues };
...
export const EnvironmentVariable = ({
  ...
  const envVarContextValue = { name, value };
