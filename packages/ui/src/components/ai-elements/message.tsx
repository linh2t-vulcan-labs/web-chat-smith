...
export const MessageBranchContent = ({
  ...
  // Use useEffect to update branches when they change. Recomputed from
  // `children` (the real reactive input) instead of depending on
  // `childrenArray`, which is a fresh array wrapper every render.
  useEffect(() => {
