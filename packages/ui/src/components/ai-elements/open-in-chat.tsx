...
const providers = {
  chatgpt: {
    ...
    icon: (
      <svg
        fill="currentColor"
        // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- inline SVG icon, role="img" + <title> is the standard accessible-name pattern
        role="img"
        viewBox="0 0 24 24"
  ...
  claude: {
    ...
    icon: (
      ...
      >
        ...
        <path
          clipRule="evenodd"
          d="M2.35 7.98L4.71 6.65L4.75 6.54L4.71 6.47H4.6L4.21 6.45L2.86 6.41L1.69 6.37L.55 6.3L.27 6.24L0 5.89L.03 5.72L.27 5.56L.61 5.59L1.37 5.64L2.51 5.72L3.34 5.76L4.56 5.89H4.75L4.78 5.81L4.71 5.76L4.66 5.72L3.48 4.92L2.21 4.07L1.54 3.59L1.18 3.34L1 3.11L.92 2.61L1.25 2.25L1.69 2.28L1.8 2.31L2.25 2.65L3.2 3.39L4.44 4.3L4.63 4.46L4.7 4.41L4.71 4.37L4.63 4.23L3.95 3.01L3.23 1.76L2.9 1.25L2.82 .94C2.79 .82 2.77 .7 2.77 .57L3.14 .07L3.35 0L3.85 .07L4.06 .25L4.37 .96L4.87 2.07L5.64 3.59L5.87 4.03L5.99 4.45L6.04 4.58H6.12V4.5L6.18 3.65L6.3 2.6L6.42 1.26L6.46 .88L6.64 .42L7.02 .18L7.31 .32L7.55 .66L7.52 .88L7.37 1.81L7.09 3.26L6.91 4.23H7.02L7.14 4.11L7.63 3.45L8.46 2.42L8.82 2.01L9.25 1.56L9.52 1.34H10.04L10.42 1.91L10.25 2.49L9.72 3.17L9.28 3.74L8.64 4.59L8.25 5.27L8.28 5.32L8.38 5.31L9.81 5.01L10.58 4.87L11.5 4.71L11.91 4.91L11.96 5.1L11.8 5.51L10.81 5.75L9.66 5.98L7.94 6.39L7.92 6.4L7.94 6.43L8.72 6.51L9.05 6.52H9.86L11.37 6.64L11.76 6.9L12 7.22L11.96 7.46L11.35 7.77L10.53 7.57L8.62 7.12L7.96 6.95H7.87V7.01L8.42 7.54L9.42 8.45L10.68 9.61L10.74 9.9L10.58 10.13L10.41 10.11L9.31 9.28L8.88 8.9L7.92 8.09H7.85V8.18L8.07 8.5L9.25 10.26L9.31 10.8L9.22 10.98L8.92 11.09L8.59 11.03L7.9 10.06L7.19 8.98L6.62 8.01L6.55 8.05L6.21 11.68L6.05 11.86L5.69 12L5.39 11.77L5.23 11.4L5.39 10.66L5.58 9.7L5.74 8.93L5.88 7.98L5.97 7.67L5.96 7.64L5.89 7.65L5.17 8.64L4.08 10.11L3.22 11.03L3.01 11.11L2.65 10.93L2.69 10.6L2.89 10.3L4.08 8.79L4.8 7.84L5.27 7.3L5.26 7.22H5.24L2.07 9.28L1.5 9.35L1.26 9.12L1.29 8.75L1.4 8.63L2.36 7.97L2.35 7.98Z"
          fillRule="evenodd"
        />
      </svg>
    ),
...
export const OpenInTrigger = ({ children, ...props }: OpenInTriggerProps) =>
  children ? (
    <DropdownMenuTrigger render={children as React.ReactElement} {...props} />
  ) : (
    <DropdownMenuTrigger
...
export const OpenInChatGPT = (props: OpenInChatGPTProps) => {
  ...
  return (
    <DropdownMenuItem
      render={
        // oxlint-disable-next-line jsx-a11y/anchor-has-content, jsx-a11y/control-has-associated-label -- generic passthrough render-prop; content is always supplied by the DropdownMenuItem children below
        <a
