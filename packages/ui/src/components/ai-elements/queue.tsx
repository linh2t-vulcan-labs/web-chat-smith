...
export const QueueItemImage = ({
  ...
  // oxlint-disable-next-line next/no-img-element, react-doctor/nextjs-no-img-element -- generic component accepting arbitrary caller-supplied src, not a fixed next/image-optimizable remote asset
  <img
    alt=""
