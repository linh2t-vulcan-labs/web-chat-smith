...
interface VoiceSelectorContextValue {
  ...
  setValue: (value: string | undefined | ((prev: string) => string)) => void;
  open: boolean;
...
export const VoiceSelector = ({
  ...
  const [open, setOpen] = useControllableState({
    ...
    onChange: (nextOpen: boolean) => onOpenChange?.(nextOpen, {} as never),
    prop: openProp,
  });
...
export const VoiceSelectorAccent = ({
  ...
  const emoji = value ? (ACCENT_EMOJI[value] ?? null) : null;
