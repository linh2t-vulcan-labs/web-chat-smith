...
const AvatarBadge = ({ className, ...props }: React.ComponentProps<"span">) => (
  <span
    ...
    className={cn(
      "bg-primary text-primary-foreground ring-background absolute inset-e-0 bottom-0 z-10 inline-flex items-center justify-center rounded-full bg-blend-color ring-2 select-none",
