  ...
  return (
    <SidebarContext value={contextValue}>
      ...
      <div
        ...
        className={cn(
          "group/sidebar-wrapper flex min-h-svh w-full has-data-[variant=inset]:bg-sidebar focus-visible:ring-2 focus-visible:ring-cs-border-interactive-focus focus-visible:outline-none",
          className
        )}
        {...props}
      >
...
const SidebarInset = ({
  ...
  <main
    ...
    className={cn(
      "relative flex w-full flex-1 flex-col bg-background md:peer-data-[variant=inset]:m-cs-content-tight md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2",
      className
    )}
    {...props}
  />
...
const SidebarHeader = ({
  ...
  <div
    ...
    data-sidebar="header"
    className={cn(
      "flex flex-col gap-cs-content-tight p-cs-content-tight",
      className
    )}
    {...props}
  />
...
const SidebarSeparator = ({
  ...
  <Separator
    ...
    className={cn("mx-cs-content-tight w-auto bg-sidebar-border", className)}
    {...props}
  />
);
...
const SidebarGroup = ({ className, ...props }: React.ComponentProps<"div">) => (
  <div
    ...
    data-sidebar="group"
    className={cn(
      "relative flex w-full min-w-0 flex-col p-cs-content-tight",
      className
    )}
    {...props}
  />
...
const SidebarGroupLabel = ({
  ...
  useRender({
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          "flex h-8 shrink-0 items-center rounded-md px-cs-content-tight text-xs font-medium text-sidebar-foreground/70 ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
          className
        ),
      },
      props
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group/menu-button flex w-full items-center gap-cs-content-tight overflow-hidden rounded-md p-cs-content-tight text-start text-sm ring-sidebar-ring outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pe-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground data-active:bg-sidebar-accent data-active:font-medium data-active:text-sidebar-accent-foreground [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate",
  {
    defaultVariants: {
      size: "default",
      variant: "default",
...
const SidebarMenuBadge = ({
  ...
  <div
    ...
    className={cn(
      "pointer-events-none absolute inset-e-1 flex h-5 min-w-5 items-center justify-center rounded-md px-cs-content-micro text-xs font-medium text-sidebar-foreground tabular-nums select-none group-data-[collapsible=icon]:hidden peer-hover/menu-button:text-sidebar-accent-foreground peer-data-[size=default]/menu-button:top-1.5 peer-data-[size=lg]/menu-button:top-2.5 peer-data-[size=sm]/menu-button:top-1 peer-data-active/menu-button:text-sidebar-accent-foreground",
      className
    )}
    {...props}
  />
...
const SidebarMenuSkeleton = ({
  ...
  return (
    <div
      ...
      className={cn(
        "flex h-8 items-center gap-cs-content-tight rounded-md px-cs-content-tight",
        className
      )}
      {...props}
    >
...
const SidebarMenuSub = ({
  ...
  <ul
    ...
    className={cn(
      "mx-3.5 flex min-w-0 translate-x-px rtl:-translate-x-px flex-col gap-cs-content-micro border-s border-sidebar-border px-2.5 py-0.5 group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
  />
...
const SidebarMenuSubButton = ({
  ...
  useRender({
    ...
    props: mergeProps<"a">(
      {
        className: cn(
          "flex h-7 min-w-0 -translate-x-px rtl:translate-x-px items-center gap-cs-content-tight overflow-hidden rounded-md px-cs-content-tight text-sidebar-foreground ring-sidebar-ring outline-hidden group-data-[collapsible=icon]:hidden hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[size=md]:text-sm data-[size=sm]:text-xs data-active:bg-sidebar-accent data-active:text-sidebar-accent-foreground [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground",
          className
        ),
      },
      props
